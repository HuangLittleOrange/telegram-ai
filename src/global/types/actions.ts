...
export interface ActionPayloads {
  ...
  setAiThinkingEndedAt: {
    thinkingEndedAt?: number;
  } & WithTabId;
  appendAiThinkingTrace: {
    trace: AiThinkingTraceStepInput;
  } & WithTabId;
  clearAiThinkingTrace: WithTabId | undefined;
  setAiError: {
    error?: string;
  } & WithTabId;
  clearAiTurns: WithTabId | undefined;
  appendAiTurn: {
    role: 'user' | 'assistant';
    text: string;
    createdAt?: number;
